...
if ($totalFiles -gt 0) {
    ...
    Write-Host "   🛡️ Error Handling: $($errorScore.ToString('F1')) (sampled)" -ForegroundColor White
}
...
Write-Host "🏗️ 3. ARCHITECTURE COMPLIANCE" -ForegroundColor Yellow
Write-Host ("-" * 40) -ForegroundColor Gray
...
Write-Host "   🏛️ Domain Layer: $domainFiles files" -ForegroundColor White
Write-Host "   🏛️ Application Layer: $applicationFiles files" -ForegroundColor White
Write-Host "   🏛️ Infrastructure Layer: $infrastructureFiles files" -ForegroundColor White
Write-Host "   🏛️ API Layer: $apiFiles files" -ForegroundColor White
...
Write-Host "💾 4. DATABASE & PERSISTENCE" -ForegroundColor Yellow
Write-Host ("-" * 40) -ForegroundColor Gray
...
Write-Host "   🗄️ DbContext Present: $hasDbContext" -ForegroundColor White
...
Write-Host "🧪 6. TESTING & QUALITY ASSURANCE" -ForegroundColor Yellow
Write-Host ("-" * 40) -ForegroundColor Gray
...
$grade = ""
$emoji = ""
if ($finalScore -ge 90) { $grade = "A+"; $emoji = "Trophy" }
elseif ($finalScore -ge 80) { $grade = "A"; $emoji = "Gold" }
elseif ($finalScore -ge 70) { $grade = "B+"; $emoji = "Silver" }
elseif ($finalScore -ge 60) { $grade = "B"; $emoji = "Bronze" }
elseif ($finalScore -ge 50) { $grade = "C"; $emoji = "Chart" }
else { $grade = "D"; $emoji = "Warning" }
